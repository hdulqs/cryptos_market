  ...
  render() {
    ...
    return(
      <Grid fluid={true}>
        ...
        <p className='text-center sessions_error'>{this.props.errors.code} {this.props.errors.message && this.props.errors.message.length && this.props.errors.message.join(", ")}</p>
        ...
        <Form horizontal>
          ...
          <FormGroup controlId="formHorizontalEmail">
            <Col sm={3}> </Col>
            <Col sm={6}> <FormControl type="email" placeholder="Email" value={this.state.registration.email} onChange={this.email_form_update} /> </Col>
            <Col sm={3}> </Col>
            </FormGroup>

          <FormGroup controlId="formHorizontalPassword">
            <Col sm={3}> </Col>
            <Col sm={6}> <FormControl type="password" placeholder="Password" value={this.state.registration.password} onChange={this.password_form_update} /> </Col>
            <Col sm={3}> </Col>
          </FormGroup>

          <FormGroup controlId="formHorizontalPasswordConfirmation">
            <Col sm={3}> </Col>
            <Col sm={6}> <FormControl type="password" placeholder="Password Confirmation" value={this.state.registration.password_confirmation} onChange={this.password_confirmation_form_update} /> </Col>
            <Col sm={3}> </Col>
          </FormGroup>
          ...
          <FormGroup>
            <Col sm={3}> </Col>
            <Col sm={6}> <Button className='btn btn-block btn-info' type="submit" onClick={this.navigate_to_sign_in}>Sign in</Button> </Col>
            <Col sm={3}> </Col>
          </FormGroup>
