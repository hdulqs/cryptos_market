    ...
    return(
      <div className='candle-chart'>
        ...
        <header className="asset_show_header">
          <Button type="submit" value="none" className={this.state.time_scale === '1m' ? 'btn active' : 'btn'} onClick={this.one_month_scale}>1 Month</Button>&nbsp;
          <Button type="submit" value="none" className={this.state.time_scale === '7d' ? 'btn active' : 'btn'} onClick={this.seven_days_scale}>7 Days</Button>&nbsp;
          <Button type="submit" value="none" className={this.state.time_scale === '1d' ? 'btn active' : 'btn'} onClick={this.one_day_scale}>1 Day</Button>&nbsp;
          <Button type="submit" value="none" className={this.state.time_scale === '6h' ? 'btn active' : 'btn'} onClick={this.six_hours_scale}>6 Hours</Button>
        </header>
