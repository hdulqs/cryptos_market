class TickerFetcherJob < ApplicationJob
  ...
  def perform pair_id
    ...
    if pair.market.is_watched && pair.is_watched
      ...
      if pair.exchange.last_ticker_request && (pair.exchange.last_ticker_request > (DateTime.current - 12.seconds)) # last_ticker_request Happened less than 30 seconds ago
